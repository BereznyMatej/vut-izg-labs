/******************************************************************************
 * Laborator 04 Curves - Zaklady pocitacove grafiky - IZG
 * ihulik@fit.vutbr.cz
 *
 * $Id:$
 *
 ...
 *
 * Opravy a modifikace:
 * -isvoboda@fit.vutbr.cz - Dodefinovan typ bool, Point2d
...
#define IZG_CHECK(cond, msg) if(!(cond)) IZG_ERROR(msg)
...
/******************************************************************************
 * Uzitecne uzivatelske typy pro lab 04
 */

/**
 * Struktura Point2d zaobaluje souradnice bodu [x;y]
 */
...
#else
// V C neni typ bool definovany, tak si jej dodefinujeme, nu proc ne...
