 ...
 * @date        20.05.2018
 *
 * @brief       Definice datovych typu pro barvu pixelu a pomocne funkce pro
 *              praci s nimi.
 */
...
typedef struct RGBA
{
	...
	{
		RGBA c;
		c.red = (unsigned char) ((1 - factor) * c1.red + factor * c2.red);
		c.green = (unsigned char) ((1 - factor) * c1.green + factor * c2.green);
		c.blue = (unsigned char) ((1 - factor) * c1.blue + factor * c2.blue);
		return c;
	}
} RGBA;
