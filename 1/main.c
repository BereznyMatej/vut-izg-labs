...
void onDraw(void)
{
	...
	/* Test, pokud kopirujeme rozdilnou velikost frame_bufferu a rozdilne
	 * pameti, musime pamet prealokovat */
...
void onKeyboard(SDL_KeyboardEvent *key)
{
	...
	switch (key->keysym.sym)
	{
		...
		case SDLK_r:
			/* Stisknuti R tlacitka prevadi obrazek na cernobily pomoci
			 * nahodneho rozptyleni */
			IZG_INFO(
				"Converting image to black and white using randomized "
				"dithering.\n"
			);
			randomDithering();
			break;
		...
		case SDLK_m:
			/* Stisknuti M tlacitka prevadi obrazek na cernobily pomoci
			 * maticoveho rozptyleni */
			IZG_INFO(
				"Converting image to black and white using ordered "
				"dithering.\n"
			);
			orderedDithering();
			break;
		...
		case SDLK_d:
			/* Stisknuti D tlacitka prevadi obrazek na cernobily pomoci
			 * distribuce chyby */
			IZG_INFO(
				"Converting image to black and white using error "
				"distribution.\n"
			);
			errorDistribution();
			break;
		...
		case SDLK_1:
			/* Stisknuti 1 tlacitka prevadi obrazek na cernobily pomoci
			 * prahovani s prahem = 50 */
			IZG_INFO(
				"Converting image to black and white using thresholding "
				"(threshold = 50).\n"
			);
			thresholding(50);
			break;
		...
		case SDLK_2:
			/* Stisknuti 2 tlacitka prevadi obrazek na cernobily pomoci
			 * prahovani s prahem = 100 */
			IZG_INFO(
				"Converting image to black and white using thresholding "
				"(threshold = 100).\n"
			);
		...
		case SDLK_3:
			/* Stisknuti 3 tlacitka prevadi obrazek na cernobily pomoci
			 * prahovani s prahem = 150 */
			IZG_INFO(
				"Converting image to black and white using thresholding "
				"(threshold = 150).\n"
			);
		...
		case SDLK_4:
			/* Stisknuti 4 tlacitka prevadi obrazek na cernobily pomoci
			 * prahovani s prahem = 200 */
			IZG_INFO(
				"Converting image to black and white using thresholding "
				"(threshold = 200).\n"
			);
...
void onMouseDown(SDL_MouseMotionEvent *mouse)
{
	...
	{
		/* Pokud je zmacknuto tlacitko, cteme pixely za pomoci IZG_GetPixel
		 * metody */
		S_RGBA color = getPixel(mouse->x, mouse->y);
		printf(
			"Info: Click on coordinates %d %d: RGB(%d %d %d)\n",
			mouse->x,
			mouse->y,
			color.red,
			color.green,
